  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30">
      ...
      <section
        ...
        className="container mx-auto px-4 py-12 md:py-20 lg:py-32 flex flex-col items-center justify-center text-center"
      >
        <motion.div
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-medium mb-4 md:mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
            <Button onClick={() => scrollToSection("about")} className="text-sm sm:text-base">
              About Me
            </Button>
            <Button
              variant="outline"
        ...
        >
          ...
          <Card>
            <CardContent className="pt-4 md:pt-6">
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 mt-4 md:mt-6">
      ...
      <section
        ...
        className="container mx-auto px-4 py-12 md:py-16 lg:py-24 bg-muted/30 rounded-lg"
      >
        <motion.div
          initial="hidden"
          whileInView="show"
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center">Experience</h2>
              ...
              <Card>
                <CardHeader>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    <div>
                      <CardTitle className="text-lg md:text-xl">React.js Frontend Developer Intern</CardTitle>
                      <CardDescription>ByteUprise · Remote</CardDescription>
                    </div>
                    <Badge variant="secondary" className="w-fit">Jan 2025 - Present</Badge>
                  </div>
                </CardHeader>
            ...
            <motion.div variants={item}>
              <Card>
                <CardHeader>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    <div>
                      <CardTitle className="text-lg md:text-xl">Web Developer Intern</CardTitle>
                      <CardDescription>
                        Techpile Technology Pvt. Ltd. · On-site
                      </CardDescription>
                    </div>
                    <Badge variant="secondary" className="w-fit">Jul 2024 - Dec 2024</Badge>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2">
                  <p className="text-sm md:text-base">
      ...
      >
        <motion.div
          ...
          className="max-w-4xl mx-auto"
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center">Skills</h2>

          <Tabs defaultValue="programming" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 gap-1">
              <TabsTrigger value="programming" className="text-xs sm:text-sm">Languages</TabsTrigger>
            ...
            <TabsContent value="programming" className="mt-4 md:mt-6">
              <motion.div
                variants={item}
              ...
              >
                {["JavaScript (ES6+)", "C", "C++"].map((skill) => (
                  <Badge
                    key={skill}
                    variant="outline"
                    className="py-2 md:py-3 justify-center text-center hover:bg-primary hover:text-primary-foreground transition-colors text-xs sm:text-sm"
                  >
                    {skill}
                  </Badge>
                ))}
            ...
            <TabsContent value="frameworks" className="mt-4 md:mt-6">
              <motion.div
                variants={item}
                className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4"
                initial="hidden"
            ...
            <TabsContent value="tools" className="mt-4 md:mt-6">
              <motion.div
                variants={item}
                className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4"
                initial="hidden"
            ...
            <TabsContent value="databases" className="mt-4 md:mt-6">
              <motion.div
                variants={item}
                className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4"
                initial="hidden"
      ...
      >
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center">Projects</h2>
      ...
      >
        <motion.div
          ...
          className="max-w-4xl mx-auto"
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center">Education</h2>
              ...
              <Card>
                <CardHeader>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    ...
                    <Badge className="w-fit">2023-2025</Badge>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm md:text-base">CGPA: 7.0</p>
                </CardContent>
              </Card>
            </motion.div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    ...
                    <Badge className="w-fit">2020-2023</Badge>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm md:text-base">CGPA: 7.3</p>
                </CardContent>
              </Card>
            </motion.div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    ...
                    <Badge className="w-fit">2017-2018</Badge>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm md:text-base">CGPA: 6.8</p>
                </CardContent>
              </Card>
            </motion.div>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 md:mb-8">
            <Card className="flex flex-col items-center p-4 md:p-6 hover:shadow-md transition-shadow">
              <Mail className="h-8 w-8 md:h-10 md:w-10 text-primary mb-2 md:mb-4" />
              <h3 className="text-base md:text-lg font-medium mb-1 md:mb-2">Email</h3>
            ...
            <Card className="flex flex-col items-center p-4 md:p-6 hover:shadow-md transition-shadow">
              <Phone className="h-8 w-8 md:h-10 md:w-10 text-primary mb-2 md:mb-4" />
              <h3 className="text-base md:text-lg font-medium mb-1 md:mb-2">Phone</h3>
              <p className="text-xs md:text-sm text-muted-foreground mb-2 md:mb-4">
                +917393931450
              </p>
              <Button variant="outline" size="sm" asChild className="w-full">
            ...
            <Card className="flex flex-col items-center p-4 md:p-6 hover:shadow-md transition-shadow col-span-1 md:col-span-2 lg:col-span-1">
              <MapPin className="h-8 w-8 md:h-10 md:w-10 text-primary mb-2 md:mb-4" />
...
function ProjectCard({
  ...
  return (
    <Card className="h-full hover:shadow-md transition-shadow overflow-hidden">
      ...
      <CardContent className="pb-1 md:pb-2">
        <p className="text-muted-foreground line-clamp-4 text-sm md:text-base">{description}</p>
